define(require => {
    ...
    class PrizeBonus extends Pressable {
        ...
        constructor(props) {
            ...
            // Better to have Fitted Texts to avoid long strings break and fit always the text.
            this.valueTexts = [new FittedText(''), new FittedText('')];
        ...
        showValue(value) {
            ...
            return new Promise(resolve => {
                ...
                this.backgroundAnim.state.setAnimation(0, 'PrizeBonus/GoldBarLEFT_revealed_BLUE', true);


                //console.log("SHOW VALUE -->" + 'PrizeBonus/GoldBar' + this.prefix + '_revealed_BLUE');
                ...
                if (this.value === "Z") {
                    ...
                    this.FittedTextContainer.addChild(text);
                    this.coinAnim.slotContainers[this.coinAnim.spineData.findSlotIndex("Collect_Text")].addChild(this.FittedTextContainer);
                ...
                if (this.value === "Z") {
                    ...
                    this.valueTexts.forEach(function(valueText) {
                        valueText.alpha = 0;
                        valueText.text = SKBeInstant.formatCurrency(prizeData.prizeTable[_this.value]).formattedAmount.replace(" ", "\u0020");
                        valueText.maxWidth = 200;
