define(require => {
    ...
    function getWinAndReset() {
        let total = SKBeInstant.formatCurrency(wheelBonusTotalWin).formattedAmount.replace(" ", "\u0020");
        reset();
        return total;
    }
    ...
    function showWinArea() {
        ...
        displayList.wheelTotalWinValue.text = SKBeInstant.formatCurrency(wheelBonusTotalWin).formattedAmount.replace(" ", "\u0020");
        displayList.wheelTotalWinValueGradient.text = SKBeInstant.formatCurrency(wheelBonusTotalWin).formattedAmount.replace(" ", "\u0020");
        ...
        Tween.to(displayList.wheelBonusLogo, 0.5, {
            alpha: 0,
            delay: 1,
            onComplete: function() {
                displayList.wheelBonusLogo.renderable = false;
    ...
    function showWin() {
        ...
        displayList.wheelWinPrizeValue.text = SKBeInstant.formatCurrency(wheelBonusCashPrize).formattedAmount.replace(" ", "\u0020");
        displayList.wheelWinPrizeValueGradient.text = SKBeInstant.formatCurrency(wheelBonusCashPrize).formattedAmount.replace(" ", "\u0020");
