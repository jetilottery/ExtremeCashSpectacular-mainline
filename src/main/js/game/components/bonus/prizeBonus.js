define(require => {
    ...
    function init() {
        ...
        pickerArray = [
            ...
            new PrizeBonusPicker({
                prefix: 'LEFT',
                container: displayList.picker_4,
                index: 6
            }),
            new PrizeBonusPicker({
                prefix: 'MIDDLE',
                container: displayList.picker_5,
                index: 5
            }),
            new PrizeBonusPicker({
                prefix: 'RIGHT',
                container: displayList.picker_6,
                index: 4
            }),
            new PrizeBonusPicker({
                prefix: 'LEFT',
                container: displayList.picker_7,
                index: 3
            }),
            new PrizeBonusPicker({
                prefix: 'MIDDLE',
                container: displayList.picker_8,
                index: 2
            }),
            new PrizeBonusPicker({
                prefix: 'RIGHT',
                container: displayList.picker_9,
                index: 1
            }),
        ];
                ...
                await new Promise(resolve => {
                    ...
                    tl.fromTo(displayList.collectInfoLogo, fadeTime, {
                        ...
                        onComplete: function() {
                            ...
                            Tween.to(logoGlowContainer, glowFadeTime, {
                                alpha: 1,
                    ...
                    tl.fromTo(displayList.collectInfoTotalWinHeader, fadeTime, {
                        ...
                        alpha: 1,
                        y: displayList.collectInfoSprite.y + displayList.collectInfoSprite.height + 50, //.y,
                        ease: window.Power2.easeOut
                    }, timeDiff);
    ...
    function getWinAndReset() {
        let total = SKBeInstant.formatCurrency(totalWinValue).formattedAmount.replace(" ", "\u0020");
    ...
    function updateAndAnimateWinValue(totalWinValueText) {
        ...
        totalWinValueText.text = SKBeInstant.formatCurrency(totalWinValue).formattedAmount.replace(" ", "\u0020");
