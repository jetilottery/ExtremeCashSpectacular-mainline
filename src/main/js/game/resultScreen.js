define(function(require) {
    ...
    function resultScreen() {
        ...
        displayList.winPlaqueValue.text = SKBeInstant.formatCurrency(meterData.totalWin).formattedAmount.replace(" ", "\u0020");
        displayList.winPlaqueValue1.text = SKBeInstant.formatCurrency(meterData.totalWin).formattedAmount.replace(" ", "\u0020");
    }
